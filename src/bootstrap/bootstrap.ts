...
class Bootstrap {
    ...
    private _fetchModules( useClass: any = null ) {
        if   (!useClass) useClass = new MainModule();
    ...
    private _registerRoutesWithControllers(): void {
        ...
        this._controllers.forEach(( controller ) => {
            ...
            const validateProperties: Map<string,ValidateObjectMetaData> = Reflect.getMetadata(MiddlewareProperties.ValidateProperties, controller) || {};
